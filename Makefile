...
PATHFINDER_TEST_TARGET = test_pathfinder
...
clean:
	rm -f $(OBJS) src/main.o $(TARGET) vectma_headless tests/*.o $(TEST_TARGET) $(SYNC_TEST_TARGET) $(GEOM_TEST_TARGET) $(BOOL_TEST_TARGET) $(COMP_TEST_TARGET) $(LAYOUT_TEST_TARGET) $(CANVAS_TEST_TARGET) $(TOKEN_TEST_TARGET) $(SELECTION_TEST_TARGET) $(PROTOTYPE_TEST_TARGET) $(ASSETS_TEST_TARGET) $(PATHFINDER_TEST_TARGET)
	rm -rf build/assets

test: $(TEST_TARGET) $(SYNC_TEST_TARGET) $(GEOM_TEST_TARGET) $(BOOL_TEST_TARGET) $(COMP_TEST_TARGET) $(LAYOUT_TEST_TARGET) $(CANVAS_TEST_TARGET) $(TOKEN_TEST_TARGET) $(SELECTION_TEST_TARGET) $(PROTOTYPE_TEST_TARGET) $(ASSETS_TEST_TARGET) $(PATHFINDER_TEST_TARGET)
	./$(TEST_TARGET)
	./$(SYNC_TEST_TARGET)
	./$(GEOM_TEST_TARGET)
	./$(BOOL_TEST_TARGET)
...
$(PATHFINDER_TEST_TARGET): tests/test_pathfinder.o $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) -o $@ $^ -lpthread -lm -ldl
